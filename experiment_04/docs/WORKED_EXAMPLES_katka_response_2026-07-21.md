...
`cs\_cltt` trees, so any error is in OUR rule, not in a parser.
...
* `cs\_cltt/cs\_cltt-ud-dev.conllu::260`
  ...
  * \[ ] ✓
* `cs\_cltt/cs\_cltt-ud-test.conllu::257`
  ...
  * \[ ] ✓
* `cs\_cltt/cs\_cltt-ud-test.conllu::43`

  * 1:Informace 2:je 3:srovnatelná, 4:jestliže 5:splňuje 6:požadavky 7:stanovené 8:v 9:§\_7\_odst.\_3\_až\_5.
  * ★ featured pair: **Informace** (word 1) ↔ **je** (word 2) → distance **0**
  * \[ ] ✓

## copular — past copula (byla)  (3 pairs in CLTT)

* `cs\_cltt/cs\_cltt-ud-test.conllu::2`
  ...
  * \[ ] ✓
* `cs\_cltt/cs\_cltt-ud-train.conllu::449`
  ...
  * \[ ] ✓
* `cs\_cltt/cs\_cltt-ud-dev.conllu::143`
...
* `cs\_cltt/cs\_cltt-ud-dev.conllu::87`
  ...
  * \[ ] ✓
* `cs\_cltt/cs\_cltt-ud-test.conllu::92`
  ...
  * \[ ] ✓
* `cs\_cltt/cs\_cltt-ud-dev.conllu::251`
...
* `cs\_cltt/cs\_cltt-ud-dev.conllu::115`
  ...
  * \[ ] ✓
* `cs\_cltt/cs\_cltt-ud-test.conllu::286`
  ...
  * \[ ] ✓ 
* `cs\_cltt/cs\_cltt-ud-train.conllu::140`
...
* `cs\_cltt/cs\_cltt-ud-dev.conllu::250`
  ...
  * \[ ] ✓
* `cs\_cltt/cs\_cltt-ud-train.conllu::296`
  ...
  * \[ ] ✓
* `cs\_cltt/cs\_cltt-ud-train.conllu::410`
...
* `cs\_cltt/cs\_cltt-ud-test.conllu::314`
  ...
  * \[ ] ✓
* `cs\_cltt/cs\_cltt-ud-train.conllu::285`
  ...
  * \[ ] ✓ 
* `cs\_cltt/cs\_cltt-ud-train.conllu::308`

  * 1:Informace 2:podle 3:písmen 4:a)\_a\_b) 5:není 6:účetní 7:jednotka 8:povinna 9:uvést, 10:pokud 11:byly 12:transakce 13:provedeny 14:mezi 15:účetní 16:jednotkou 17:a 18:jejím 19:jediným 20:společníkem.
...
* `cs\_cltt/cs\_cltt-ud-test.conllu::166`
  ...
  * \[ ] ✓ 
* `cs\_cltt/cs\_cltt-ud-test.conllu::144`
  ...
  * \[ ] ✓:
* `cs\_cltt/cs\_cltt-ud-train.conllu::108`
...
* `cs\_cltt/cs\_cltt-ud-dev.conllu::205`: Hospodářským rokem je účetní období, které může začínat pouze prvním dnem jiného měsíce, než je leden.
* `cs\_cltt/cs\_cltt-ud-dev.conllu::272`: (1) Nestanoví-li tento zákon nebo zvláštní právní předpis jinak, účetní jednotky jsou povinny vést účetnictví v plném rozsahu.
* `cs\_cltt/cs\_cltt-ud-test.conllu::127`: (2) Konsolidující účetní jednotky neuvedené v odstavci 1 mohou pro sestavení konsolidované účetní závěrky použít mezinárodní účetní standardy.
* `cs\_cltt/cs\_cltt-ud-test.conllu::223`: Nestanoví-li tento zákon jinak, platí pro nakládání s nimi zvláštní právní předpisy.
